...
class QimeraRBM(RBM):
    ...
    def __init__(self, n_visible, n_hidden, bernoulli=False, **kwargs):
        ...
        n_cells = max(math.ceil(n_visible/_CELL_SIDE_QUBITS),
                      math.ceil(n_hidden/_CELL_SIDE_QUBITS))
        ...
        for edge in qpu_edges:
            ...
            if (edge[0] in visible_qubit_idxs and
                edge[1] in hidden_qubit_idxs) or (edge[0] in hidden_qubit_idxs
                                                  and edge[1] in
                                                  visible_qubit_idxs):
        ...
        # Chimera-RBM matrix
        visible_qubit_idx_map = {visible_qubit_idx: i for i, visible_qubit_idx
                                 in enumerate(visible_qubit_idxs)}
        hidden_qubit_idx_map = {hidden_qubit_idx: i for i, hidden_qubit_idx
                                in enumerate(hidden_qubit_idxs)}
