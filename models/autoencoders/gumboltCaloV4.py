...
V4 - Energy conditioning added to the decoder
...
class GumBoltCaloV4(GumBolt):
    
    def __init__(self, **kwargs):
        super(GumBoltCaloV4, self).__init__(**kwargs)
        self._model_type = "GumBoltCaloV4"
    ...
    def forward(self, x, is_training):
        ...
        out.beta, out.post_logits, out.post_samples = self.encoder(x[0], is_training)
    ...
    def _create_decoder(self):
        logger.debug("GumBoltCaloV4::_create_decoder")
