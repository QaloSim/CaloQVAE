...
class DiVAE(AutoEncoderBase):
    ...
    def kl_div_prior_gradient(self, posterior_logits, posterior_binary_samples):
        ...
        #-zT*Weights*z 
        pos_first_term=torch.matmul(positive_samples_left,self.prior.weights)*positive_samples_right
       
        rbm_bias_left=self.prior.visible_bias
        rbm_bias_right=self.prior.hidden_bias
        ...
        neg_first_term=torch.matmul(negative_samples_left,self.prior.weights)*negative_samples_right
