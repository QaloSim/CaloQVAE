...
class GumBoltAtlasCRBMCEncUDec(GumBoltAtlasCRBMCNN):
    """
    GumBolt
    """

    def __init__(self, **kwargs):
        super(GumBoltAtlasCRBMCEncUDec, self).__init__(**kwargs)
        self._model_type = "GumBoltAtlasCRBMCEncUDec"
    ...
    def _create_encoder(self):
        ...
        """
        logger.debug("GumBoltAtlasCRBMCEncUDec::_create_encoder")
