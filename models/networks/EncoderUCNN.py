...
class EncoderUCNNH(HierarchicalEncoder):
    ...
    def _create_hierarchy_network(self, level: int = 0):
        ...
        for l in range(len(layers)-1):
            ...
            elif self.encArch == 'UncondSmall':
                moduleLayers.append(EncoderBlockUncondSmall(layers[l], layers[l+1]))
...
class EncoderBlockUncondSmall(nn.Module):
    def __init__(self, num_input_nodes, n_latent_nodes):
        super(EncoderBlockUncondSmall, self).__init__()
        self.num_input_nodes = num_input_nodes
        self.n_latent_nodes = n_latent_nodes
        self.minEnergy = 256
