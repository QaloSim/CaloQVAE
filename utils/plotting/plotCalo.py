...
#     image_list = []
#     for idx in range(layer_images[0].shape[0]):
#         image_list.append(plot_atlas_image2(layer_images[0]))      
...
def plot_atlas_image2(image):
    image = HLF_1_photons.DrawSingleShower(image, filename=None)
#     image = HLF_1_photons.DrawAverageShower(image, filename=None)
#     fig, ax = plt.subplots(nrows=1, ncols=len(image), figsize=(12, 4))
#     plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace=0.45, hspace=None)
